...
#    define mem_new(I, N, O, C, S)        memory_new_s((I), (void**)(N), (void*)(O), (size_t)(C), (size_t)(S))
#    define mem_del(I, N)                 memory_del_s((I), (void**)(N))
#else
...
#    define mem_sort(P, C, S, F)          memory_sort((void*)(P), (size_t)(C), (size_t)(S), (memory_func_comp_t)(F))
#    define mem_bsearch(R, K, P, C, S, F) memory_bsearch((void**)(R), (void*)(K), (void*)(P), (size_t)(C), (size_t)(S), (memory_func_comp_t)(F))
#    define mem_rsearch(R, K, P, C, S, F) memory_rsearch((void**)(R), (void*)(K), (void*)(P), (size_t)(C), (size_t)(S), (memory_func_comp_t)(F))
#    define mem_dump(P)                   memory_dump((void*)(P), 0, 1, 16)
#    define mem_look(P, C, S, M)          memory_look((void*)(P), (size_t)(C), (size_t)(S), M)

#    define mem_list(...)                 memory_list(__VA_ARGS__)
