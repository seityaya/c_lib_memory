...
bool memory_req(void **ptr, size_t count, size_t size) {
    ...
    if (*ptr == NULL) {
        ...
        size_t produce = malloc_usable_size(mem_new); // TODO danger!!!
        ...
        *ptr = mem_new->memory_ptr;
        ...
        mem_old = (*ptr) - offsetof(memory_t, memory_ptr);
        ...
        size_t new_size = malloc_usable_size(mem_new); // TODO danger!!!
...
bool memory_ret_s(memory_stats_t *mem_stats, void **ptr) {
    ...
    size_t memory_release = mem->memory_produce;
